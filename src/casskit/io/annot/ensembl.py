...
class EnsemblData:
    ...
    def tss_from_ensembl(self, gtf_path) -> pr.PyRanges:
        ...
        return (ensembl_pr[((ensembl_pr.Feature == "exon") &
                ...
                .df
                .astype({"Chromosome": str, "Start": "int32", "End": "int32",
                         "gene_name": str, "gene_id": str})
                .assign(Chromosome=lambda df: "chr"+df["Chromosome"])
                .groupby(["Chromosome", "gene_name", "gene_id"])
                .agg(Start=pd.NamedAgg(column="Start", aggfunc=np.nanmin),
    ...
    def annotate_df(
        ...
        return cls.annotate_pyranges(gene_ids, assembly=assembly,
